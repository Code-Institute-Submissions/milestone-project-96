...
![Fray + Anchor responsive website example](https://github.com/chloelewisdev/milestone-project-1/blob/master/assets/images/mockupscreenshot.png)
...
* Feature ‘Scroll to top’ button – this feature enables the user to quickly move back to the top of the page, rather than having to scroll back up, improving the user experience. 
